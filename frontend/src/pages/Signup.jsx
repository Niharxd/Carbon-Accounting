...
export default function Signup() {
  ...
  return (
    <div className="relative glass border border-emerald-500/20 rounded-2xl p-10 max-w-lg mx-auto shadow-2xl shadow-emerald-500/10 overflow-hidden">
      <div className="absolute top-0 left-0 w-64 h-64 bg-emerald-500/10 rounded-full blur-3xl -ml-16 -mt-16 pointer-events-none" />
      <div className="relative z-10 space-y-6">
        <div className="space-y-2">
          <p className="text-blue-300 text-xs font-bold uppercase tracking-widest">Create your account</p>
          <h1 className="text-3xl font-black">Start tracking emissions</h1>
          <p className="text-slate-400 text-sm">Sign up to save predictions, view analytics, and access your dashboard.</p>
        </div>
